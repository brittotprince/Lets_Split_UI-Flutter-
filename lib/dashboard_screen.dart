...
class DashboardScreen extends StatelessWidget {
  ...
  //       "userName": "Neeraj",
  //       "transactions": {
  //         "Split": {"you_owe": 0, "owes_you": 573.94}
  //       }
  //     },
  //     "66ba0dfe65c1d782f22d5e03": {
  //       "userName": "Vishnu",
  //       "transactions": {
  //         "Split": {"you_owe": 0, "owes_you": 471.07}
  //       }
  //     }
  //   }
  // };
      ...
      body: Padding(
        ...
        child: ListView(
          children: data['transactionsPerPerson'].entries.map<Widget>((entry) {
            ...
            final userName = userData['otherPersonName'];
            final transactions = userData['transactions'];
            final totalOwesYou = transactions.values
                .fold(0, (sum, item) => sum + item['owes_you']);
            final totalYouOwe = transactions.values
                .fold(0, (sum, item) => sum + item['you_owe']);
